...
Agreement and the provision the parties intend to modify or amend.<br><br>
    ...
    <iframe
      id="JotFormIFrame-252365843484162"
      title="Varian Limited Use Software License Agreement (SRShelper)"
      onload="window.parent.scrollTo(0,0)"
      allowtransparency="true"
      allow="geolocation; microphone; camera; fullscreen; payment"
      src="https://form.jotform.com/252365843484162"
      frameborder="0"
    ...
    <script>window.jotformEmbedHandler("iframe[id='JotFormIFrame-252365843484162']", "https://form.jotform.com/")</script>
